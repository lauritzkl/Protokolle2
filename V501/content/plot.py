...
plt.plot(x2_plot, f(x2_plot, *params1), 'k-', label='Regression')
plt.legend()
plt.grid()
plt.xlabel(r'$U_d \, / \, \si{\volt}$')
plt.ylabel(r'$D \, / \, \si{\centi\meter}$')
...
plt.plot(x3_plot, f(x3_plot, *params2), 'k-', label='Regression')
plt.legend()
plt.grid()
plt.xlabel(r'$U_d \, / \, \si{\volt}$')
plt.ylabel(r'$D \, / \, \si{\centi\meter}$')
...
plt.plot(x4_plot, f(x4_plot, *params3), 'k-', label='Regression')
plt.legend()
plt.grid()
plt.xlabel(r'$U_d \, / \, \si{\volt}$')
plt.ylabel(r'$D \, / \, \si{\centi\meter}$')
...
plt.plot(x5_plot, f(x5_plot, *params4), 'k-', label='Regression')
plt.legend()
plt.grid()
plt.xlabel(r'$U_d \, / \, \si{\volt}$')
plt.ylabel(r'$D \, / \, \si{\centi\meter}$')
...
#Berechnung zur Konstruktionskonstanten
