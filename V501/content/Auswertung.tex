...
\begin{itemize}
  \item $m = \SI{8.93(23)}{\per\meter\milli\Tesla}$
  \item $b =\SI{0.07(02)}{\per\meter}$
\end{itemize}
...
Die Parameter ergeben sich hierfür
\begin{itemize}
  \item $m = \SI{8.12(25)}{\per\meter\milli\Tesla}$
  \item $b =\SI{0.09(03)}{\per\meter}$
\end{itemize}
...
Die Parameter ergeben sich hierfür
\begin{itemize}
  \item $m = \SI{7.58(19)}{\per\meter\milli\Tesla}$
  \item $b =\SI{0.05(02)}{\per\meter}$
\end{itemize}
...
Die Parameter ergeben sich hierfür
\begin{itemize}
  \item $m = \SI{7.13(17)}{\per\meter\milli\Tesla}$
  \item $b =\SI{0.07(02)}{\per\meter}$
\end{itemize}
...
Die Parameter ergeben sich hierfür
\begin{itemize}
  \item $m = \SI{6.87(16)}{\per\meter\milli\Tesla}$
  \item $b =\SI{0.07(02)}{\per\meter}$
\end{itemize}
