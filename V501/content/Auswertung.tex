...
Nun wird die Steigung, in diesem Fall die Empfindlichkeit $\frac{D}{U_d}$ genannt, gegen $\frac{1}{U_B}$ aufgetragen.
...
\begin{table}[H]
  ...
  \begin{tabular}{c c c c c c}
\toprule
%& \multicolumn{1}{c}{$U_B=\SI{250}{\ampere}$} & \multicolumn{1}{c}{$U_B=\SI{300}{\ampere}$} &\multicolumn{1}{c}{$U_B=\SI{350}{\ampere}$}&\multicolumn{1}{c}{$U_B=\SI{400}{\ampere}$}&\multicolumn{1}{c}{$U_B=\SI{430}{\ampere}$}\\
%\cmidrule(lr){2}\cmidrule(lr){3}\cmidrule(lr){4}\cmidrule(lr){5}
